...
export async function POST(request: Request) {
    try {
        ...
        const data: any = {
            ...
            horasExtras: (calculatedData.horasExtras || 0) + (calculatedData.horasPendientes || 0),
            montoHorasExtras: (calculatedData.montoHorasExtras || 0) + (calculatedData.montoHorasPendientes || 0),
