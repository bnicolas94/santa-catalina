...
- Los depósitos de locales mueven el importe al declararse desde la Caja Chica hacia la caja activa de la misma sede marcada como `recibeDepositos` (Caja Fuerte). El sobre queda pendiente allí; al validarlo, se ajustan diferencias con contrapartida en ambas cajas y se transfiere desde la Caja Fuerte hacia la caja final elegida. Los usuarios que no son ADMIN pueden ver la Caja Fuerte, pero no registrar, editar, anular, ajustar ni transferir movimientos directos en ella; sólo pueden acreditarla mediante este circuito de depósito. No pueden depositar más que el saldo disponible de la Caja Chica salvo que un ADMIN activo autorice en el momento con sus credenciales; la autorización queda en la auditoría del movimiento. Los depósitos históricos sin caja de recepción conservan su conciliación anterior.
