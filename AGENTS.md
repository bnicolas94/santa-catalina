...
- Los depósitos de locales reservan el importe desde el saldo existente de la caja vinculada al declararse y lo acreditan en la caja destino al validarse. No pueden superar el saldo disponible salvo que un ADMIN activo autorice en el momento con sus credenciales; la autorización queda en la auditoría del movimiento. La validación distingue por el tipo del movimiento de declaración para conservar la conciliación de depósitos históricos pendientes.
