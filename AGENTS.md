...
- La liquidación semanal asigna una caja de pago por empleado, sugiriendo una caja activa de su sede y permitiendo corregirla antes de confirmar. Cada liquidación genera su propio egreso en la caja elegida; el selector global sólo actúa como valor predeterminado y nunca reescribe pagos históricos.
